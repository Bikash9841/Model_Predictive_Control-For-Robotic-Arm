...
def visualize(desiredTrajectoryList1, controlledTrajectoryList1, desiredTrajectoryList2, controlledTrajectoryList2,
    ...
    axs[0, 0].plot(controlledTrajectoryList1, linewidth=4, linestyle='dashed', color='black',
    ...
    axs[0, 1].plot(controlledTrajectoryList2, linewidth=4, linestyle='dashed', color='black',
                   label='Controlled trajectory2')
    axs[0, 1].set_title('JOINT 2')
    axs[0, 1].set_ylabel('Joint Angles (in deg)')
    axs[0, 1].set_xlabel('timesteps')
    axs[0, 1].legend()
    # ---------------------------------------------------------------

    # axs[1, 0].plot(desiredTrajectoryList3, linewidth=4, color='black',
    #                label='Desired trajectory3')
    # axs[1, 0].plot(controlledTrajectoryList3, linewidth=4, linestyle='dashed', color='black',
    #                label='Controlled trajectory3')
    # axs[1, 0].set_title('JOINT 3')
    # axs[1, 0].set_ylabel('Joint Angles (in deg)')
    # axs[1, 0].set_xlabel('timesteps')
    # axs[1, 0].legend()
    # # ---------------------------------------------------------------

    # axs[1, 1].plot(desiredTrajectoryList4, linewidth=4, color='black',
    #                label='Desired trajectory4')
    # axs[1, 1].plot(controlledTrajectoryList4, linewidth=4, linestyle='dashed', color='black',
    #                label='Controlled trajectory4')
    # axs[1, 1].set_title('JOINT 4')
    # axs[1, 1].set_ylabel('Joint Angles (in deg)')
